export default function WorkCardWrapper() {
  return (
    <div
      className="Wrapper absolute left-1/2 top-1/2  -translate-x-1/2 -translate-y-1/2 rounded-2xl border-[2.5rem] border-solid border-grau-1 transition duration-300 ease-in-out

      before:absolute before:left-1/2 before:top-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rounded-2xl before:border-[2.3rem] before:border-dotted before:border-grau-2 before:blur-[7px] before:transition before:duration-300 before:ease-in-out

      after:absolute after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-2xl after:border-[2.3rem] after:border-dotted after:border-grau-5 after:transition after:duration-300 after:ease-in-out group-hover/card:blur-[7px] group-hover/card:before:blur-[20px]
